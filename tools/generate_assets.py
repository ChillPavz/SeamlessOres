...
CREATE_JAR = os.environ.get(
    "CREATE_JAR",
    "../references/jars/26.1.2-create-fly-26.1.2-6.0.9-4.jar",
)
...
ENERGIZEDPOWER_JAR = os.environ.get("ENERGIZEDPOWER_JAR", "../references/jars/26.1.2-energizedpower-3.0.0+26.1.x-neoforge.jar")
...
# Sept 2026 wave: the three with a 26.1.x build, each re-fetched for it. Tech Reborn 6.0.5 is one file
# for 26.1 to 26.1.2. Occultism's 26.1 and 26.1.2 files ship identical silver loot, tags and art, so
# the 26.1.2 one serves the range. Mystical Agriculture has 26.1.2 only.
TECHREBORN_JAR = os.environ.get("TECHREBORN_JAR", "../references/jars/26.1.x-TechReborn-6.0.5.jar")
OCCULTISM_JAR = os.environ.get("OCCULTISM_JAR", "../references/jars/occultism-26.1.2-neoforge-1.251.0.jar")
MYSTICAL_AGRICULTURE_JAR = os.environ.get("MYSTICAL_AGRICULTURE_JAR",
                                          "../references/jars/MysticalAgriculture-26.1.2-9.0.9.jar")
