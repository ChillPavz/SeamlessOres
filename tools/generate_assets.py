...
CREATE_JAR = os.environ.get(
    "CREATE_JAR",
    "../jars/26.1.2-create-fly-26.1.2-6.0.9-4.jar",
)
...
POWAH_JAR = os.environ.get("POWAH_JAR", "../jars/26.1.2-Powah-7.0.4-alpha.jar")

TFMG_JAR = os.environ.get("TFMG_JAR", "../jars/tfmg-1.2.2.jar")

ENERGIZEDPOWER_JAR = os.environ.get("ENERGIZEDPOWER_JAR", "../jars/26.1.2-energizedpower-3.0.0+26.1.x-neoforge.jar")
