 ...
 * {@code AutoConfigClient.getConfigScreen} does not merely return some {@code Supplier<Screen>}; it
...
public final class SeamlessOresConfigScreenFactory {
    ...
    public static Screen create(Screen parent) {
        final Supplier<Screen> supplier = AutoConfigClient.getConfigScreen(SeamlessOresConfigData.class, parent);
